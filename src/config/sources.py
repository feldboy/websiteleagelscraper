...
class LegalSources:
    ...
    # Note: These are working legal news sources
    # In production, verify compliance with each source's terms of service
    SOURCES: Dict[str, SourceConfig] = {
        "law_com": SourceConfig(
            name="Law.com",
            url="https://www.law.com",
            article_list_path="/",
            article_selector="h3.headline a, h2.headline a",
            title_selector="h1.headline, h1",
            content_selector=".article-wrap .article-content, .entry-content",
        ...
        "law360_backup": SourceConfig(
            name="Law360 Public",
            url="https://www.law360.com",
            article_list_path="/sections/technology",
            article_selector="a[href*='/articles/']",
            title_selector="h1, .headline",
            content_selector=".article-text, .article-content",
            date_selector=".article-date, time",
            author_selector=".author, .byline",
            rate_limit_delay=4.0,
            max_articles_per_cycle=8,
            include_keywords=["technology", "data", "privacy", "cyber"],
